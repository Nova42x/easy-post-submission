...
if ( ! function_exists( 'easy_post_submission_description_strings' ) ) {
    ...
    function easy_post_submission_description_strings() {
        ...
        return [
            'ok'                                   => esc_html__( '确定', 'easy-post-submission' ),
            'delete'                               => esc_html__( '删除', 'easy-post-submission' ),
            'confirmDelete'                        => esc_html__( '确认删除', 'easy-post-submission' ),
            'submit'                               => esc_html__( '提交', 'easy-post-submission' ),
            'cancel'                               => esc_html__( '取消', 'easy-post-submission' ),
            'post'                                 => esc_html__( '文章标题', 'easy-post-submission' ),
            'categories'                           => esc_html__( '分类', 'easy-post-submission' ),
            'createdDate'                          => esc_html__( '创建时间', 'easy-post-submission' ),
            'status'                               => esc_html__( '状态', 'easy-post-submission' ),
            'views'                                => esc_html__( '浏览量', 'easy-post-submission' ),
            'actions'                              => esc_html__( '操作', 'easy-post-submission' ),
            'noPostShowTitle'                      => esc_html__( '暂无文章显示！', 'easy-post-submission' ),
            'noPostShowDesc'                       => esc_html__( '我们期待看到您的投稿！请提交您的文章以展示在这里。', 'easy-post-submission' ),
            'needLogin'                            => esc_html__( '请登录以继续', 'easy-post-submission' ),
            'morePosts'                            => esc_html__( '加载更多文章', 'easy-post-submission' ),
            'postListLabel'                        => esc_html__( '我的文章', 'easy-post-submission' ),
            'editPost'                             => esc_html__( '编辑文章', 'easy-post-submission' ),
            'submitPost'                           => esc_html__( '提交文章', 'easy-post-submission' ),
            /* translators: %s is the title or name of the post */
            'postDeleteSuccessfulMessage'          => esc_html__( '%s 已成功删除。', 'easy-post-submission' ),
            /* translators: %s is the title or name of the post */
            'confirmDeleteMessage'                 => esc_html__( '您确定要删除文章：%s 吗？', 'easy-post-submission' ),
            'yourName'                             => esc_html__( '您的姓名', 'easy-post-submission' ),
            'hindYourName'                         => esc_html__( '请输入您的全名。', 'easy-post-submission' ),
            'yourEmail'                            => esc_html__( '您的邮箱', 'easy-post-submission' ),
            'hindYourEmail'                        => esc_html__( '您的邮箱地址不会公开显示，仅用于管理目的和联系您有关文章的事宜。', 'easy-post-submission' ),
            'challengeTitle'                       => esc_html__( '验证问题', 'easy-post-submission' ),
            'challengeLabel'                       => esc_html__( '请回答问题：', 'easy-post-submission' ),
            'invalidAnswer'                        => esc_html__( '答案无效，请输入有效的回答。', 'easy-post-submission' ),
            'addPostTitle'                         => esc_html__( '添加标题', 'easy-post-submission' ),
            'hindPostTitle'                        => esc_html__( '简洁为上！建议将文章标题保持在50到70个字符之间，以提高吸引力。', 'easy-post-submission' ),
            'addPostExcerpt'                       => esc_html__( '添加摘要', 'easy-post-submission' ),
            'hindPostExcerpt'                      => esc_html__( '建议长度约20到55个字。简洁的摘要能够概括文章精华，而不透露全部内容。', 'easy-post-submission' ),
            'addPostContent'                       => esc_html__( '添加文章内容', 'easy-post-submission' ),
            'textAreaFormPlaceholder'              => esc_html__( '在此开始撰写您的内容...', 'easy-post-submission' ),
            'hindPostContent'                      => esc_html__( '以引人入胜的开场白开始，吸引读者的注意力，让他们继续阅读。', 'easy-post-submission' ),
            'titlePostCategories'                  => esc_html__( '分类', 'easy-post-submission' ),
            'choosePostCategories'                 => esc_html__( '选择分类', 'easy-post-submission' ),
            'hindPostCategories'                   => esc_html__( '选择能够准确反映文章内容的分类。', 'easy-post-submission' ),
            'titlePostTags'                        => esc_html__( '文章标签', 'easy-post-submission' ),
            'addPostTags'                          => esc_html__( '添加标签', 'easy-post-submission' ),
            'choosePostTags'                       => esc_html__( '选择标签', 'easy-post-submission' ),
            'hindPostTags'                         => esc_html__( '选择与文章内容最相关的标签。', 'easy-post-submission' ),
            'titlePostFeatured'                    => esc_html__( '特色图片', 'easy-post-submission' ),
            'hindPostFeatured'                     => esc_html__( '相关的高质量图片能够有效传达内容精髓，吸引受众的注意力。', 'easy-post-submission' ),
            'chooseFeaturedImage'                  => esc_html__( '选择图片', 'easy-post-submission' ),
            'editFeaturedImage'                    => esc_html__( '编辑特色图片', 'easy-post-submission' ),
            'submitPostLabel'                      => esc_html__( '提交文章', 'easy-post-submission' ),
            'updatePostLabel'                      => esc_html__( '更新文章', 'easy-post-submission' ),
            'challengeRequiredInput'               => esc_html__( '必须回答问题！', 'easy-post-submission' ),
            'verifyFailedRecaptchaMessage'         => esc_html__( 'reCAPTCHA 验证失败', 'easy-post-submission' ),
            'maxAmountImages'                      => esc_html__( '图片上传数量上限', 'easy-post-submission' ),
            /* translators: %s is the maximum number of images allowed */
            'maxAmountImagesMessage'               => esc_html__( '您已达到 %s 张图片的最大限制。', 'easy-post-submission' ),
            'updating'                             => esc_html__( '更新中', 'easy-post-submission' ),
            'submitting'                           => esc_html__( '提交中', 'easy-post-submission' ),
            /* translators: %s is the name or title of the post */
            'updatePostSuccessMessage'             => esc_html__( '%s 已成功更新。', 'easy-post-submission' ),
            /* translators: %s is the name or title of the post */
            'submitPostSuccessMessage'             => esc_html__( '%s 已成功添加。', 'easy-post-submission' ),
            'updatePostSuccessTitle'               => esc_html__( '文章已更新', 'easy-post-submission' ),
            'submitPostSuccessTitle'               => esc_html__( '文章已提交', 'easy-post-submission' ),
            'updatePostFailedTitle'                => esc_html__( '更新失败', 'easy-post-submission' ),
            'submitPostFailedTitle'                => esc_html__( '提交失败', 'easy-post-submission' ),
            'register'                             => esc_html__( '注册', 'easy-post-submission' ),
            'login'                                => esc_html__( '登录', 'easy-post-submission' ),
            'requiredLoginTitlePattern'            => esc_html__( '需要登录才能提交', 'easy-post-submission' ),
            'requiredLoginDescPattern'             => esc_html__( '要继续编辑您的文章，请登录您的账户。', 'easy-post-submission' ),
            'userPostsRequiredLoginTitlePattern'   => esc_html__( '需要登录才能访问文章', 'easy-post-submission' ),
            'userPostsRequiredLoginMessagePattern' => esc_html__( '您需要登录才能查看所有文章。请登录以继续。', 'easy-post-submission' ),
            'editPostRequiredLoginTitlePattern'    => esc_html__( '需要登录才能编辑文章', 'easy-post-submission' ),
            'editPostRequiredLoginMessagePattern'  => esc_html__( '您必须登录才能编辑此文章。请登录以继续。', 'easy-post-submission' ),
            'titleRequiredRule'                    => esc_html__( '请输入标题。', 'easy-post-submission' ),
            'excerptRequiredRule'                  => esc_html__( '请提供摘要。', 'easy-post-submission' ),
            'userNameRequiredRule'                 => esc_html__( '请输入您的用户名。', 'easy-post-submission' ),
            'userEmailRequiredRule'                => esc_html__( '请输入您的邮箱地址。', 'easy-post-submission' ),
            'title'                                => esc_html__( '标题', 'easy-post-submission' ),
            'excerpt'                              => esc_html__( '摘要', 'easy-post-submission' ),
            'userName'                             => esc_html__( '用户名', 'easy-post-submission' ),
            'userEmail'                            => esc_html__( '用户邮箱', 'easy-post-submission' ),
            'isMissing'                            => esc_html__( '缺失。请提供。', 'easy-post-submission' ),
            'areMissing'                           => esc_html__( '缺失。请提供。', 'easy-post-submission' ),
            'imageSizeLimitTitle'                  => esc_html__( '图片大小限制', 'easy-post-submission' ),
            /* translators: %s is the size of the image in KB */
            'imageSizeLimitMessage'                => esc_html__( '图片大小已超出允许的限制，最大为 %s KB。', 'easy-post-submission' ),
            'invalidIndexToInsertImage'            => esc_html__( '无效的编辑器图片插入位置', 'easy-post-submission' ),
            'noSelection'                          => esc_html__( '编辑器中没有选择', 'easy-post-submission' ),
            'error'                                => esc_html__( '错误！', 'easy-post-submission' ),
            'errorMessage'                         => esc_html__( '此提交表单已被网站管理员删除。请稍后再试。', 'easy-post-submission' ),
            'unSaved'                              => esc_html__( '未保存的更改', 'easy-post-submission' ),
            'unSavedMessage'                       => esc_html__( '您确定要在不保存更改的情况下重新加载页面吗？', 'easy-post-submission' ),
        ];
    }
}